...
public class BossBarGUi {
    ...
    public void renderBossBar(CustomizeGuiOverlayEvent.BossEventProgress event){
        ...
        if(achPatch != null){
            ...
            var barPoseStack = guiGraphics.pose();
            ...
            guiGraphics.blit(achPatch.getBossBar(), x, y, 0, 0, 256, 19, 255, 255);
            guiGraphics.blit(achPatch.getBossBar(), x, y, 0, 21, health, 19, 255, 255);
            guiGraphics.blit(achPatch.getBossBar(), x, y + 18, 0, 42, 256, 10, 255, 255);
            guiGraphics.blit(achPatch.getBossBar(), x, y + 18, 0, 55, stamina, 10, 255, 255);
            guiGraphics.blit(achPatch.getBossBar(), x, y, 0, 68, 256, 29, 255, 255);
            barPoseStack.popPose();
            guiGraphics.drawString(Minecraft.getInstance().font, achPatch.getCustomName(), i1, y - 9, 16777215, true);
